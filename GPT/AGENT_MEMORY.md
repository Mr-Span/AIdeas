...
- Current code: AI-002 durable intake, AI-003 owner-local execution and AI-004
  specialized research are integrated. AI-004 now also requires provider
  consent/redaction preview, supports explicit client-question publication,
  retry of incomplete roles on the original digest, bounded budgets and
